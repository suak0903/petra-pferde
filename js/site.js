/* PETRA LADENBURGER - Chrome/Interaktion (Vanilla, kein Framework).
   Funktionsliste (Kit-Checkliste): Nav-Scroll · Mobile-Menü (Morph, ESC, Swipe, Scroll-Lock)
   · Smooth-Scroll · Reveal · Hero-Parallaxe · Demo-Leiste · Back-to-Top · Scrollspy
   · Ribbon-Marquee (mobil) · Lightbox · Galerie-Masonry (LPT). */
(function(){
  'use strict';
  ...
  /* Hero-Parallaxe 50% (Desktop + Mobil), rAF-gedrosselt, nur transform */
